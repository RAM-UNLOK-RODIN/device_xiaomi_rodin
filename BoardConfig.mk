...
# Path to your prebuilt kernel
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel

# Path to prebuilt DTB
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/dtb.img

# Use prebuilt kernel in vendor_boot
BOARD_VENDOR_KERNEL_IMAGE := $(TARGET_PREBUILT_KERNEL)
BOARD_PREBUILT_VENDOR_BOOT_KERNEL := $(TARGET_PREBUILT_KERNEL)
BOARD_PREBUILT_VENDOR_BOOT_DTB := $(TARGET_PREBUILT_DTB)
...
# Maintainer/Version
TW_DEVICE_VERSION := ram-unlok/beta-1
